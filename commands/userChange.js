    ...
    handleSubChange(props) {
        ...
        if (self) {
            setTimeout(() => subStatus
                ...
                : bot.say(chatroom, `Aww, did I lose my sub? ${negativeEmote}`), 2000)
        } else if (subStatus) {
    ...
    handleModChange(props) {
        ...
        if (self) {
            setTimeout(() => modStatus
                ? bot.say(chatroom, `Thank you for modding me! ${positiveEmote}`)
                : bot.say(chatroom, `Was I just unmodded? ${negativeEmote}`), 2000)
        } else if (modStatus) {
    ...
    handleVIPChange(props) {
        ...
        if (self) {
            setTimeout(() => vipStatus
                ? bot.say(chatroom, `Thank you for giving me VIP! ${positiveEmote}`)
                : bot.say(chatroom, `Did I just lose VIP? ${negativeEmote}`), 2000)
        } else if (vipStatus) {
