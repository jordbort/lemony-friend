...
function cli(chatroom, args) {
    if ([`settings`, `s`].includes(args[0]?.toLowerCase())) {
        if (debug.aliases.includes(args[1]?.toLowerCase())) {
            if (![...trueAliases, ...falseAliases].includes(args[2]?.toLowerCase())) { return talk(chatroom, `> Setting '${debug.name}' must be of value BOOLEAN (currently: ${settings[debug.name]})`) }
            ...
            if (![...trueAliases, ...falseAliases].includes(args[2]?.toLowerCase())) { return talk(chatroom, `> Setting '${firstconnection.name}' must be of value BOOLEAN (currently: ${settings[firstconnection.name]})`) }
            ...
            if (![...trueAliases, ...falseAliases].includes(args[2]?.toLowerCase())) { return talk(chatroom, `> Setting '${sayonlinemsg.name}' must be of value BOOLEAN (currently: ${settings[sayonlinemsg.name]})`) }
        ...
        if (user in users) {
            if ([`delete`, `d`].includes(args[2]?.toLowerCase())) {
                ...
                if (sub.aliases.includes(args[3]?.toLowerCase())) {
                    if (![...trueAliases, ...falseAliases].includes(args[4]?.toLowerCase())) { return talk(chatroom, `> User in ${channel}'s '${sub.name}' must be of value BOOLEAN (currently: ${users[user][channel][sub.name]})`) }
                    ...
                    if (![...trueAliases, ...falseAliases].includes(args[4]?.toLowerCase())) { return talk(chatroom, `> User in ${channel}'s '${mod.name}' must be of value BOOLEAN (currently: ${users[user][channel][mod.name]})`) }
                    ...
                    if (![...trueAliases, ...falseAliases].includes(args[4]?.toLowerCase())) { return talk(chatroom, `> User in ${channel}'s '${vip.name}' must be of value BOOLEAN (currently: ${users[user][channel][vip.name]})`) }
                    ...
                    if (![...trueAliases, ...falseAliases].includes(args[4]?.toLowerCase())) { return talk(chatroom, `> User in ${channel}'s '${away.name}' must be of value BOOLEAN (currently: ${users[user][channel][away.name]})`) }
        ...
        if (![`jpegstripes`, `j`, `sclarf`, `s`, `e1ectroma`, `e`, `domonintendo1`, `d`, `ppuyya`, `p`].includes(args[1]?.toLowerCase())) { return talk(chatroom, `> You must specify a Lemony Fresh member`) }
        ...
        if (args[1] in timers) {
            if (cooldown.aliases.includes(args[2]?.toLowerCase())) {
                ...
                if (![...trueAliases, ...falseAliases].includes(args[3]?.toLowerCase())) { return talk(chatroom, `> Timer ${args[1]} '${listening.name}' must be of value BOOLEAN (currently: ${timers[args[1]][listening.name]})`) }
